...
public class FoodItemSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_ELEMENT) {
            return new RestaurantSearchAdapter.FirstElementSearchViewHolder(firstV);
        }
        return new RestaurantSearchAdapter.RestaurantSearchViewHolder(v);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder.getClass() == RestaurantSearchAdapter.FirstElementSearchViewHolder.class) {
